"""
Data Lineage Dashboard Page for Streamlit Multi-Page App
"""
...
Built on [OpenLineage](https://openlineage.io/) standard for data governance.
""")
...
st.markdown("""
---
**Data Lineage Dashboard** | [OpenLineage Standard](https://openlineage.io/)
...
- View at: `/pages/lineage_dashboard.py`
""")
